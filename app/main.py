...
from app.routes import resumes, tailoring, auth, admin, interview_prep, star_stories, resume_analysis, certifications, saved_comparisons, jobs, career_path, applications, cover_letters, resume_versions, reminders, auth_test, recordings, debug
